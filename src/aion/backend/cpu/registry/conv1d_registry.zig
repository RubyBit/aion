...
pub const candidates = [_]Candidate{
    .{ .id = .simd128, .kernels = kernelsFor(.{ .unroll_k3 = false, .lanes = 4 }) },
    .{ .id = .simd256, .kernels = kernelsFor(.{ .unroll_k3 = true, .lanes = 8 }) },
    .{ .id = .simd512, .kernels = kernelsFor(.{ .unroll_k3 = true, .lanes = 16 }) },
};
