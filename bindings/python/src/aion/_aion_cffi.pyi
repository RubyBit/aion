...
class Lib(Protocol):
    ...
    def aion_loaded_model_load_path_on(self, ctx: CData, path: CData, kind: int, index: int, out_model: CData) -> int: ...
    def aion_loaded_model_load_path_absolute_on(self, ctx: CData, absolute_path: CData, kind: int, index: int, out_model: CData) -> int: ...
